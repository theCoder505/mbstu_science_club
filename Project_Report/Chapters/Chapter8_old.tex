...
The ultimate goal is to offer this software to \textit{other} clubs in MBSTU. By adding a `club_id` column to every table and using Laravel's Tenant package, we can host 50+ clubs on a single server, creating a university-wide ecosystem.
